...
void function InitMainMenu()
{
	...
	// Create cvars used by Project P1L0T UI helpers (Lobby Tools) so builds that
	// require pre-existing cvars don't throw 'ConVar is not valid'.
	...
	try
	{
		var p1lotLogoRui = Hud_GetRui( Hud_GetChild( file.menu, "P1L0TLogoRui" ) )
		RuiSetImage( p1lotLogoRui, "basicImage", $"vgui/p1lot/logo" )
	}
	catch ( ex )
	{
	}
...
void function UpdateTrialLabel()
{
	...
	Hud_SetColor( file.trialLabel, 220, 60, 60, 255 )
	Hud_SetText( file.trialLabel, "Project-P1L0T" )
